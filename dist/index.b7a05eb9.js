...
})({"eViCd":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
...
const Spell_limitInput = document.getElementById("input1");
const MonsterlimitInput = document.getElementById("input2");
...
function fetchNewMonsterData() {
    // Use the user input to control the number of random users to fetch
    const fetchMonsterLimit = MonsterlimitInput?.value ?? 10;
    _axiosDefault.default.request({
        method: "GET",
        url: "https://api.open5e.com/monsters/",
        params: {
            results: fetchMonsterLimit
        }
    }).then((r)=>r.data
    ).then((ru)=>{
        for(let k = 0; k < ru.results.length; k++){
            const monster = ru.results[k];
...
},{"axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"5NoCF"}],"jo6P5":[function(require,module,exports) {
...
},{"./../utils":"5By4s"}],"5NoCF":[function(require,module,exports) {
...
},{}]},["eViCd","jeorp"], "jeorp", "parcelRequire94c2")
